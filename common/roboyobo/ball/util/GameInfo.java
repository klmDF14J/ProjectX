...
public class GameInfo {
	...
	public static final float ROCK_SPEED = 0.5F;

	public static final float MIN_SHOCKWAVE_CHARGE = 2500;

	public static final int MAX_ROCKS = 30;
	...
	public static int DEAD_ROCKS; 
	public static int TIME_DEAD;
	public static int TIME_RUNNING;
	public static int SHOCKWAVES_USED;
